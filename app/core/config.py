...
DEMUCS_WORKER_IDLE_TTL = max(0, _env_int("LAYERLAB_DEMUCS_WORKER_IDLE_TTL", 15 * 60))
DEMUCS_WORKER_REAP_INTERVAL = max(5, _env_int("LAYERLAB_DEMUCS_WORKER_REAP_INTERVAL", 30))
DEMUCS_WORKER_MIN_FREE_MEMORY_GB = max(
    0.0,
    _env_float("LAYERLAB_DEMUCS_WORKER_MIN_FREE_MEMORY_GB", 2.0),
)
DEMUCS_WORKER_HEARTBEAT_INTERVAL = max(
    1,
    _env_int("LAYERLAB_DEMUCS_WORKER_HEARTBEAT_INTERVAL", 15),
)
