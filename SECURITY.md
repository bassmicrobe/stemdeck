...
NeonSplice is in active alpha. Only the latest release receives security fixes -
...
NeonSplice is local-first and single-user by design: it runs on your own machine,
...
helping keep NeonSplice users safe.
